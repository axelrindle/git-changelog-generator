...
global.program = program
    ...
    .option('--date-format <format>', `specifies the date format used in the markdown document. 
                            See https://github.com/lukeed/tinydate#patterns for a list of available patterns.`, '{DD}.{MM}.{YYYY}')
