...
global.program = program
    ...
    .option('--with-empty-tags', cliData.option['with-empty-tags'])
    .option('--date-format <format>', cliData.option['date-format'], '{DD}.{MM}.{YYYY}')
    .option('--remote <type>', cliData.option.remote)
    .option('--repo <repo>', cliData.option.repo)
    .option('-l, --limit <amount>', cliData.option.limit)
